<template>
  <div class="d-flex align-items-start justify-content-between mb-3">
    <div>
      ...
      <p class="text-muted mb-0">Adicione e acompanhe cobranças mensais.</p>
    </div>
  </div>
  ...
  <div class="row g-3">
          ...
          <form @submit.prevent="handleAdd" novalidate>
            ...
            <div class="row g-2">
              ...
              <div class="col-6">
                ...
                <input v-model="form.billingDay" type="number" min="1" max="31" class="form-control" required />
              </div>
            </div>

            <button class="btn btn-primary w-100 mt-3" type="submit" :disabled="!canSubmit">
              Adicionar
            </button>
          </form>
        </div>
    ...
    <div class="col-12 col-lg-8">
      <div class="card shadow-sm">
        <div class="card-body">
          <div class="fw-semibold mb-3">Filtros</div>
          ...
          <div class="row g-2 align-items-end">
            ...
            <div class="col-12 col-md-2">
              ...
              <select v-model="filters.sort" class="form-select">
                <option value="nextChargeAsc">Próxima cobrança</option>
            ...
            <div class="col-12">
              <div class="form-check">
                ...
                <label class="form-check-label" for="upcomingOnly">Somente próximas cobranças (7 dias)</label>
              </div>
            </div>
          </div>
          ...
          <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <button class="btn btn-sm btn-outline-secondary" type="button" @click="resetFilters">Limpar filtros</button>
          </div>

          <div v-if="filtered.length === 0" class="text-muted">
...
const categories = ["Streaming", "Software", "Jogos", "Educação", "Outros"];
